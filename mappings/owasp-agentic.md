...
| ASI03 | Identity and Privilege Abuse | AL-01, AL-04, AL-12, AL-17 | L1 (partial), L4 |
| ASI04 | Agentic Supply Chain Vulnerabilities | AL-03, AL-15 | L1 (tool pinning), L5 (signed components) |
| ASI05 | Unexpected Code Execution | none in v0.2 | Out of scope: needs runtime sandboxing |
| ASI06 | Memory and Context Poisoning | AL-06, AL-07 | L2 (partial) |
| ASI07 | Insecure Inter-Agent Communication | none in v0.2 | Planned for v0.3 (multi-agent chain rule, delegation depth) |
| ASI08 | Cascading Failures | AL-08, AL-13 | L2 (partial), L4 |
| ASI09 | Human-Agent Trust Exploitation | AL-11 | L4 |
| ASI10 | Rogue Agents | AL-02, AL-09, AL-13, AL-14, AL-16, AL-17 | L1 (detection, level integrity), L5 |
